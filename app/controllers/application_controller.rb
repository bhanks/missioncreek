class ApplicationController < ActionController::Base
  ...
  def nav_paths
	...
	@nav_paths[:residency] = (Page.exists?(:title=>"Artists Residency")) ? Rails.application.routes.url_helpers.page_path(Page.where("title = ?", "Artists Residency").first) : "javascript:void(0)"
