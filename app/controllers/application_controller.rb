class ApplicationController < ActionController::Base
  ...
  def nav_paths
	...
	@nav_paths[:residency] = (Page.exists?(:title=>"Artist Residency")) ? Rails.application.routes.url_helpers.page_path(Page.where("title = ?", "Artist Residency").first) : "javascript:void(0)"
